...
### In this lab, you have two options:

1)  Read over this lab for class 5 and take the 10 point pre-quiz for class 5.

2) As an alternative, complete this lab and you may ignore the class 5 pre-quiz. The submission of the lab will count for full credit on the pre-quiz. This option requires that you work through the lab - step by step.
